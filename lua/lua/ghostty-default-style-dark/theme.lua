...
function M.setup(opts)
  ...
  local colors, new_opts = require("ghostty-default-style-dark.colors").setup(opts)
  local groups = require("ghostty-default-style-dark.groups").setup(colors, new_opts)
