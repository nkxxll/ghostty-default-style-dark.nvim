...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("ghostty-default-style-dark.hsluv")
    if color ~= "NONE" then
...
---@param groups ghostty-default-style-dark.Highlights
...
function M.cache.read(key)
  ---@type boolean, ghostty-default-style-dark.Cache
...
---@param key string
---@param data ghostty-default-style-dark.Cache
